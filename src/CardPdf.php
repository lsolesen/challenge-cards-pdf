...
class CardPdf extends \TCPDF
{
    ...
    {
        parent::__construct('P', 'mm', 'A7', true, 'UTF-8', $disccache);
    ...
    public function addNewPage(CardInterface $card)
    {
        parent::AddPage();
        $this->SetMargins(0, 0, 0);
        $this->setX(0);
        ...
        // Add title.
        $this->addTitle("   " . $card->getTitle());

        // Add barcode.
        //$this->addBarCode($card->getUrl());

        // Add category.
        $this->addCategory($card->getCategory());

        // Add images.
        $this->setY(40);
        //$this->addImages($card->getImages());

        // Add description.
        $this->SetFont($this->font, null, 17);
        $this->setTextColor(0, 0, 0);
        $this->MultiCell(0, 8, str_replace("\n", ' ', $card->getDescription()), 0, 'L', false, 1, '', '', true, 0, true);
        ...
        $this->setY(280);
        $this->setX(6);
        $this->MultiCell(50, 8, $card->getUrl(), 0, 'C');
        */
